                ...
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">
                            @if(App\Helpers\Checker::checkAcces('categories','create')) 
...
@section('script')
    ...
    <script>
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                @if(App\Helpers\Checker::checkAcces('categories','files'))
                    { extend: 'copy'},
                    {extend: 'csv'},
    ...
    @if(App\Helpers\Checker::checkAcces('categories','show')) 
        ...
        <script>
            ...
            $("tr td:not(:nth-last-child(1))").on("click", function() {
              if (((new Date().getTime()) - touchtime) < 300) {
                    ...
                    $.ajax({
                                url: "{{ url(Config::get('constants.ADMIN_PATH').'categories/') }}"+'/'+_key,
                            })
                    .done(function(data) {
