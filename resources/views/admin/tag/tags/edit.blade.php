       ...
       <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ url(Config::get('constants.ADMIN_PATH').'tags') }}">Tags</a>
                </li>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <form id="myForm" method="POST" action="{{ url(Config::get('constants.ADMIN_PATH').'tags/' . $tag->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                           @include ('admin/tag.tags.form', ['formMode' => 'edit'])
