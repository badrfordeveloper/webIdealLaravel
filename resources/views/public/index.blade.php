<x-app page="index" >
                ...
                <div id="rev_slider_1078_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="classic4export" data-source="gallery" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
                    ...
                    <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.1">
                        ...
                        <li data-index="rs-3" data-transition="fade" data-slotamount="3" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="500"  data-thumb="http://placehold.it/60x60"  data-rotate="0"  data-saveperformance="off"  data-title="" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                ...
                                <!-- layer nr. 5 -->
                                <!-- layer nr. 5 -->
                                <a href="{{ url('services') }}" class="tp-caption btn btn-transparent-white btn-medium border-radius-4 z-index-5" 
                                   data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
        ...
        <!-- end slider section -->
        <!-- start about section --> 
        <section class="wow fadeIn cover-background md-no-background-img bg-medium-light-gray" style="background-image: url('{{ asset('assets/images/banner-bg1.jpg')}}')">
            <div class="container">
                <div class="row"> 
        ...
        <section class="p-0 wow fadeIn">
            <div class="container-fluid">
                <div class="row">
                    <!-- start features item -->
                    <div class="col-12 col-lg-3 p-0 cover-background position-relative md-height-500px sm-height-300px wow fadeIn" style="background: transparent url('{{ asset('assets/images/examples/equipe.jpg') }}')"></div>
                    <!-- end features item -->
                    <!-- start features item -->
                    ...
                    <!-- end features item -->
                    <!-- start features item -->
                    <div class="col-12 col-lg-3 p-0 cover-background position-relative md-height-500px sm-height-300px wow fadeIn" data-wow-delay="0.4s" style="background: transparent url('{{ asset('assets/images/examples/productivite.jpg') }}')"></div>
                    <!-- end features item -->
                    <!-- start features item -->
        ...
        <section class="p-0 wow fadeIn bg-light-gray">
            <div class="container-fluid">
                <div class="row"> 
                    ...
                    <div class="col-12 col-lg-6 cover-background md-height-400px wow fadeInRight" style="background-image:url('{{ asset('assets/images/examples/beautifuldigital.jpg') }}');"></div>
                </div>
            </div>
        </section>
        ...
        <section class="parallax" data-stellar-background-ratio="0" style="background-image:url('{{ asset('assets/images/examples/internet-4463031_1920.jpg') }}');">
