...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('blog/{id}/{titre}','HomeController@detailArticle')->name('detailArticle');
    ...
    Route::get('blog/{locale}/{id}/{titre}','HomeController@detailArticle')->name('detailArticleEn');
