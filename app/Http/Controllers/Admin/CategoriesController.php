...
class CategoriesController extends Controller
{
    ...
    {
        return view('admin/categorie.categories.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin/categorie.categories.show', compact('category'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/categorie.categories.edit', compact('category'));
    }
